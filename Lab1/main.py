...
else : print("Operatia de adunare este asociativa.")
...
else : print("Operatia de inmultire este asociativa.")
...
print(t6)
# i = 7
t7 = float((135135*a - 17325*(a**3) + 378*(a**5) - a**7)/(135135 - 62370*(a**2) + 3150*(a**4) - 28*(a**6)))
print(t7)
# i = 8
t8 = float((2027025*a - 17325*(a**3) + 378*(a**5) - a**7)/ (2027025 - 945945*(a**2) + 51975*(a**4) - 630*(a**6) + a**8))
print(t8)
# i = 9
t9 = float((34459425*a - 4729725*(a**3) + 135135*(a**5) - 990*(a**7) + a**9)/ (34459425 - 16216200*(a**2) + 945945*(a**4) - 13860*(a**6) + 45*(a**8)))
print(t9)
...
print(f"Lista erorilor nesortata:",list_error)
sorted_list_error = dict(sorted(list_error.items(),key= lambda x: abs(x[1])))
print(f"Lista erorilor sortata:",sorted_list_error)
